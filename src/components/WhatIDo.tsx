        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Developing advanced LLMs, intelligent agents, and custom AI applications.
                I specialize in designing systems that solve complex real-world problems.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Data & Predictive Models</h4>
              <p>
                Building, training, and deploying scalable machine learning models.
                From data preprocessing to NLP pipelines and predictive analytics.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
